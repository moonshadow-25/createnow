    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "script_line_start": {"type": "integer", "description": "本分镜覆盖的剧本起始行号（从1开始，含）。从 get_episode_script 返回的行号确定"},
                "script_line_end": {"type": "integer", "description": "本分镜覆盖的剧本结束行号（从1开始，不含）。从 get_episode_script 返回的行号确定"},
                "description_start_text": {"type": "string", "description": "（已废弃，优先使用 script_line_start / script_line_end）当前场正文中的起始锚点原文"},
                "description_end_text": {"type": "string", "description": "（已废弃，优先使用 script_line_start / script_line_end）当前场正文中的结束锚点原文"},
