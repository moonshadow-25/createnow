...
export function createStickFigurePosePreset(preset: StickFigurePosePreset, x: number, y: number): StickFigurePose {
  if (preset === 'sitting') {
    return {
      head: { x, y: y - 0.105 },
      neck: { x, y },
      hip: { x: x + 0.004, y: y + 0.145 },
      leftElbow: { x: x - 0.082, y: y + 0.028 },
      rightElbow: { x: x + 0.062, y: y + 0.026 },
      leftHand: { x: x - 0.142, y: y + 0.102 },
      rightHand: { x: x + 0.104, y: y + 0.086 },
      leftKnee: { x: x - 0.13, y: y + 0.098 },
      rightKnee: { x: x + 0.064, y: y + 0.088 },
      leftFoot: { x: x - 0.156, y: y + 0.222 },
      rightFoot: { x: x + 0.12, y: y + 0.18 },
    };
  }
  if (preset === 'lying') {
    return {
      head: { x: x - 0.12, y: y + 0.01 },
      neck: { x, y },
      hip: { x: x + 0.165, y: y - 0.01 },
      leftElbow: { x: x + 0.07, y: y - 0.055 },
      rightElbow: { x: x + 0.088, y: y + 0.032 },
      leftHand: { x: x + 0.18, y: y - 0.07 },
      rightHand: { x: x + 0.204, y: y + 0.032 },
      leftKnee: { x: x + 0.262, y: y - 0.044 },
      rightKnee: { x: x + 0.275, y: y + 0.02 },
      leftFoot: { x: x + 0.39, y: y - 0.06 },
      rightFoot: { x: x + 0.392, y: y + 0.02 },
    };
  }
  if (preset === 'kneeling') {
    return {
      head: { x, y: y - 0.085 },
      neck: { x, y },
      hip: { x: x - 0.01, y: y + 0.108 },
      leftElbow: { x: x - 0.076, y: y + 0.08 },
      rightElbow: { x: x + 0.072, y: y + 0.09 },
      leftHand: { x: x - 0.14, y: y + 0.16 },
      rightHand: { x: x + 0.132, y: y + 0.17 },
      leftKnee: { x: x - 0.025, y: y + 0.236 },
      rightKnee: { x: x + 0.062, y: y + 0.246 },
      leftFoot: { x: x - 0.1, y: y + 0.09 },
      rightFoot: { x: x + 0.11, y: y + 0.098 },
    };
  }
  return {
    head: { x, y: y - 0.112 },
    neck: { x, y },
    hip: { x, y: y + 0.198 },
    leftElbow: { x: x - 0.05, y: y + 0.102 },
    rightElbow: { x: x + 0.045, y: y + 0.09 },
    leftHand: { x: x - 0.073, y: y + 0.28 },
    rightHand: { x: x + 0.078, y: y + 0.29 },
    leftKnee: { x: x - 0.022, y: y + 0.317 },
    rightKnee: { x: x + 0.034, y: y + 0.317 },
    leftFoot: { x: x - 0.046, y: y + 0.494 },
    rightFoot: { x: x + 0.067, y: y + 0.487 },
  };
}
